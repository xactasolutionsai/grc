...
<div data-testid="sidebar">
    <aside
            class="flex w-64 shadow-2xl transition-all duration-300 fixed h-screen overflow-visible top-0 left-0 z-20 {classesSidebarOpen(
			open
		)}"
    >
        <nav class="flex-1 flex flex-col overflow-y-auto overflow-x-hidden bg-white border-r-2 border-surface-200 py-6 px-4">
            <SideBarHeader />
