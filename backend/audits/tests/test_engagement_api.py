...
class AuditEngagementAPITestCase(APITestCase):
    ...
    def setUp(self):
        ...
        self.auditor = User.objects.create_user(
            username="auditor", email="auditor@example.com", password="testpass123"
        )
        self.lead = User.objects.create_user(
            username="lead", email="lead@example.com", password="testpass123"
        )
    ...
    def test_submit_results(self):
        ...
        url = reverse(
            "audit-engagement-submit-results", kwargs={"pk": self.engagement.pk}
        )
        data = {
    ...
    def test_close_engagement(self):
        ...
        data = {"closure_notes": "Test closure notes"}
        response = self.client.post(url, data, format="json")
    ...
    def test_update_progress(self):
        ...
        url = reverse(
            "audit-engagement-update-progress", kwargs={"pk": self.engagement.pk}
        )
        data = {"progress_percentage": 50, "fieldwork_notes": "Test fieldwork notes"}
        response = self.client.post(url, data, format="json")
    ...
    def test_engagement_calendar_with_date_filter(self):
        ...
        url = reverse("audit-engagement-calendar")
        response = self.client.get(url, {"year": current_year, "month": current_month})
    ...
    def test_filter_engagements_by_date_range(self):
        ...
        response = self.client.get(
            url,
            {"planned_start_date__gte": start_date, "planned_end_date__lte": end_date},
        )
