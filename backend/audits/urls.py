...
from .views import (
    AuditEntityViewSet, AuditPlanViewSet, AuditPlanApprovalViewSet,
    AuditEngagementViewSet, ChecklistViewSet, ChecklistItemViewSet,
    ChecklistExecutionViewSet, ChecklistItemResultViewSet
)
...
router.register(r'checklist-executions', ChecklistExecutionViewSet, basename='checklist-execution')
router.register(r'checklist-item-results', ChecklistItemResultViewSet, basename='checklist-item-result')
