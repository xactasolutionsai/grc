...
class AuditEngagementAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Scope & Objectives", {"fields": ("scope", "objectives", "methodology")}),
        (
            "Progress",
            {
                "fields": (
        ...
        ("Additional", {"fields": ("tags", "attachments", "is_active")}),
    )
...
class ChecklistAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Basic Information", {"fields": ("name", "description", "folder")}),
...
class ChecklistItemAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Links", {"fields": ("control", "risk", "policy")}),
...
class ChecklistExecutionAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Basic Information", {"fields": ("checklist", "audit_engagement", "status")}),
        ("Progress", {"fields": ("total_items", "completed_items", "notes")}),
        (
            "Audit Trail",
            {
                "fields": (
...
class ChecklistItemResultAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Basic Information", {"fields": ("execution", "checklist_item", "result")}),
        (
            "Comments & Findings",
