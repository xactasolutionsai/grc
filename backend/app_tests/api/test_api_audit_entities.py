...
class TestAuditEntityGeographicalLocation:
    ...
    def test_create_audit_entity_with_geographical_data(self, api_client, user, audit_entity_data):
    ...
    @pytest.mark.django_db
    def test_get_audit_entity_with_geographical_data(self, api_client, user, audit_entity_with_location):
        """Test retrieving an audit entity with geographical location data."""
        api_client.force_authenticate(user=user)
        url = reverse('auditentity-detail', kwargs={'pk': audit_entity_with_location.pk})
    ...
    @pytest.mark.django_db
    def test_filter_audit_entities_by_country(self, api_client, user, audit_entity_with_location):
    ...
    @pytest.mark.django_db
    def test_filter_audit_entities_by_region(self, api_client, user, audit_entity_with_location):
    ...
    @pytest.mark.django_db
    def test_filter_audit_entities_by_city(self, api_client, user, audit_entity_with_location):
    ...
    @pytest.mark.django_db
    def test_search_audit_entities_by_geographical_fields(self, api_client, user, audit_entity_with_location):
    ...
    @pytest.mark.django_db
    def test_update_audit_entity_geographical_data(self, api_client, user, audit_entity_with_location):
    ...
    def test_legacy_location_field_compatibility(self, api_client, user):
        ...
        assert response_data['full_location'] == 'US, EU, APAC'  # Should fall back to legacy field
