...
class WorkpaperViewSet(viewsets.ModelViewSet):
    ...
    queryset = Workpaper.objects.select_related(
        "uploaded_by", "reviewer", "approver"
    ).all()
    ...
    def upload_file(self, request, pk=None):
        ...
        logger.info(
            f"Received file: {uploaded_file.name}, size: {uploaded_file.size}, content_type: {uploaded_file.content_type}"
        )
