...
class WorkpaperSerializer(serializers.ModelSerializer):
    ...
    def get_uploaded_by_display(self, obj):
        ...
        if obj.uploaded_by:
            ...
            display_name = (
                full_name if full_name and full_name.strip() else obj.uploaded_by.email
            )
            return {
    ...
    def get_reviewer_display(self, obj):
        ...
        if obj.reviewer:
            ...
            display_name = (
                full_name if full_name and full_name.strip() else obj.reviewer.email
            )
            return {
                "id": obj.reviewer.id,
    ...
    def get_approver_display(self, obj):
        ...
        if obj.approver:
            ...
            display_name = (
                full_name if full_name and full_name.strip() else obj.approver.email
            )
            return {
                "id": obj.approver.id,
    ...
    def validate(self, data):
        ...
        workpaper_type = data.get(
            "workpaper_type", self.instance.workpaper_type if self.instance else None
        )
...
class WorkpaperApprovalSerializer(serializers.ModelSerializer):
    ...
    def get_action_by_display(self, obj):
        ...
        if obj.action_by:
            ...
            display_name = (
                full_name if full_name and full_name.strip() else obj.action_by.email
            )
            return {
                "id": obj.action_by.id,
...
class WorkpaperActionSerializer(serializers.Serializer):
    ...
    comments = serializers.CharField(
        required=False, allow_blank=True, help_text="Comments or notes about the action"
    )
